...
- **Видит твою жизнь за компьютером.** Запустил игру в Steam — начинается охота. Включил музыку — он достаёт гитару или пляшет с постером. Печатаешь — работает рядом. Работает AI-сессия — твои успехи и провалы становятся его победами и ранами.
...
Горячие клавиши: **Alt+S** — музыкальный момент, **Alt+B** — следующая история Корвина. Кнопок «запустить сцену» в меню нет — он живёт сам.
